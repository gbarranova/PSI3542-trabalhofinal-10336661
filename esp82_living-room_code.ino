...
uint32_t delayMS;
//MQTT Credentials
const char* ssid = "42";//setting your ap ssid
const char* password = "F&Atdj4#PCAN";//setting your ap psk
const char* mqttServer = "broker.mqttdashboard.com"; //MQTT URL
const char* mqttUserName = "";  // MQTT username
const char* mqttPwd = "";  // MQTT password
const char* clientID = "clientId-0pRSk5ie2faaaa"; // client id username+0001
const char* topic = "10336661_Tempdata"; //publish topic
...
void reconnect() {
  while (!client.connected()) {
    if (client.connect(clientID, mqttUserName, mqttPwd)) {
      ...
      client.subscribe("10336661_lights");
      client.subscribe("10336661_light_1");
